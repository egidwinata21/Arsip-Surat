                ...
                <?php
                    ...
                    $cari = mysqli_real_escape_string($config, $_REQUEST['cari']);
                        ...
                        <table class="bordered" id="tbl">
                            ...
                            //script untuk mencari data
                            $query = mysqli_query($config, "SELECT tbl_surat_keluar.*, tbl_user.nama 
                            FROM tbl_surat_keluar 
                            JOIN tbl_user ON tbl_surat_keluar.id_user = tbl_user.id_user 
                            ORDER BY tbl_surat_keluar.id_surat DESC 
                            LIMIT $curr, $limit");
    ...
    while($row = mysqli_fetch_array($query)){
        ...
        <tr>
            ...
            <td>
                ...
                <strong>Ditambahkan oleh:</strong> '.$row['nama'].'<br/>

                <!-- Tindakan (edit, delete) -->
                '.(($_SESSION['id_user'] != $row['id_user'] AND $_SESSION['id_user'] != 1) ? 
