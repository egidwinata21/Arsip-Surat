    ...
    if(empty($_SESSION['admin'])){
        ...
        <!-- Container START -->
            <div id="colres">
                <div class="disp">';
                    ...
                    list($institusi, $nama, $status, $alamat, $logo) = mysqli_fetch_array($query2);
                        ...
                        echo '<span id="alamat">Gedung Fakultas Teknik UMRAH, Jl. Politeknik KM. 24, Senggarang, Tanjungpinang Kepulauan Riau</span>';
            ...
            <div id="lead">
                ...
                list($kepsek,$nim) = mysqli_fetch_array($query);
                if(!empty($kepsek)){
