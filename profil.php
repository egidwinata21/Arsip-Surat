    ...
    if(empty($_SESSION['admin'])){
        ...
        if(isset($_REQUEST['sub'])){
            ...
            if(isset($_REQUEST['submit'])){
                ...
                if($_REQUEST['username'] == "" || $_REQUEST['password'] == "" || $_REQUEST['nama'] == "" || $_REQUEST['nim'] == ""){
                    ...
                    if(!preg_match("/^[a-zA-Z0-9_]*$/", $username)){
                        ...
                        if(!preg_match("/^[a-zA-Z., ]*$/", $nama)){
                            ...
                            if(!preg_match("/^[0-9 -]*$/", $nim)){
                                $_SESSION['epnim'] = 'Form NIM hanya boleh mengandung karakter angka, spasi dan minus(-)';
                                header("Location: ./admin.php?page=pro&sub=pass");
                                die();
                            } else {
                                ...
                                if(strlen($username) < 5){
                                    ...
                                    if(strlen($password) < 5){
                                        ...
                                        if(mysqli_num_rows($query) > 0){
                                            $do = mysqli_query($config, "UPDATE tbl_user SET username='$username', password=MD5('$password'), nama='$nama', nim='$nim' WHERE id_user='$id_user'");
                    ...
                    <form class="col s12" method="post" action="?page=pro&sub=pass">
                        ...
                        <div class="row">
                            ...
                            <div class="input-field col s6">
                                ...
                                <input id="nim" type="text" class="validate" name="nim" value="<?php echo $_SESSION['nim']; ?>" required autocomplete="off">
                                    <?php
                                        if(isset($_SESSION['epnim'])){
                                            $epnim = $_SESSION['epnim'];
                                            echo '<div id="alert-message" class="callout bottom z-depth-1 red lighten-4 red-text">'.$epnim.'</div>';
                                            unset($_SESSION['epnim']);
                                        }
                                    ?>
            ...
            <div class="row jarak-form">
                ...
                <form class="col s12" method="post" action="save.php">
                    ...
                    <div class="row">
                        ...
                        <div class="input-field col s6">
                            <i class="material-icons prefix md-prefix">looks_one</i>
                            <input id="nim" type="text" value="<?php echo $_SESSION['nim']; ?>" readonly disable>
                            <label for="nim">NIM</label>
                        </div>
                    </div>
                    <!-- Row in form END -->
