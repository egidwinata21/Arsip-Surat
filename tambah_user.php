<?php
    ...
    if(empty($_SESSION['admin'])){
        ...
        if(isset($_REQUEST['submit'])){
            ...
            if($_REQUEST['username'] == "" || $_REQUEST['password'] == "" || $_REQUEST['nama'] == "" || $_REQUEST['nim'] == "" || $_REQUEST['admin'] == ""){
                ...
                if(!preg_match("/^[a-zA-Z0-9_]*$/", $username)){
                    ...
                    if(!preg_match("/^[a-zA-Z., ]*$/", $nama)){
                        ...
                        if(!preg_match("/^[0-9. -]*$/", $nim)){
                            $_SESSION['nimuser'] = 'Form NIM hanya boleh mengandung karakter angka, spasi dan minus(-)';
                            echo '<script language="javascript">window.history.back();</script>';
                        } else {
                                ...
                                if($result > 0){
                                    ...
                                    if(strlen($username) < 5){
                                        ...
                                        if(strlen($password) < 5){
                                            ...
                                            $query = mysqli_query($config, "INSERT INTO tbl_user(username,password,nama,nim,admin) VALUES('$username',MD5('$password'),'$nama','$nim','$admin')");
                    ...
                    <div class="row">
                        ...
                        <div class="input-field col s6">
                            ...
                            <input id="nim" type="text" class="validate" name="nim" required>
                                <?php
                                    if(isset($_SESSION['nimuser'])){
                                        $nimuser = $_SESSION['nimuser'];
                                        echo '<div id="alert-message" class="callout bottom z-depth-1 red lighten-4 red-text">'.$nimuser.'</div>';
                                        unset($_SESSION['nimuser']);
                                    }
                                ?>
